@extends('layouts.app', ['activePage' => 'list_schools', 'title' => 'Mathematics Challenge', 'navName' => 'list_schools', 'activeButton' => 'laravel'])
        ...
        <form action="{{ route('schools.save') }}" method="POST" class='submitForm'>
          ...
          <div class="formbold-form-step-1 active">
            <div>
              ...
              <input type="text" name="schoolName" id="schoolName" placeholder="Enter the school name" class="formbold-form-input" />
            </div>

            <div>
              <label for="address" class="formbold-form-label"> District </label>
              <input type="text" name="district" id="district" placeholder="Enter the district" class="formbold-form-input" />
            </div>
          </div>
          ...
          <div class="formbold-form-step-2">
            <div class="formbold-input-flex">
              <div>
                ...
                <input type="text" name="name" placeholder="Name" id="name" class="formbold-form-input" />
              </div>
              <div>
                <label for="lastname" class="formbold-form-label"> Password </label>
                <input type="password" name="password" placeholder="Password" id="password" class="formbold-form-input" />
              </div>
            </div>
