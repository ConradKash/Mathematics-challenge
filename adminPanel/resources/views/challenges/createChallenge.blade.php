  ...
  <div class="container-fluid">
    <div class="formbold-main-wrapper">
      <div class="formbold-form-wrapper">
        <form action="{{ route('challenges.save') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="formbold-input-flex">

            <div class="START">
              <input type="date" name="startDate" id="startDate" placeholder="Enter the start date" class="formbold-form-input" />
              <label for="startDate" class="formbold-form-label"> Start Date </label>
            </div>
            <div>
              <input type="date" name="endDate" id="endDate" placeholder="Enter the end date" class="formbold-form-input" />
          ...
          <div class="formbold-input-flex">
            <div>
              <input type="number" name="challengeDuration" id="challengeDuration" placeholder="Duration in Minutes" class="formbold-form-input" />
              <label for="duration" class="formbold-form-label"> Challenge Duration </label>
            </div>
            <div>
              <input type="number" name="questionCount" id="questionCount" placeholder="Number Of Questions" class="formbold-form-input" />
